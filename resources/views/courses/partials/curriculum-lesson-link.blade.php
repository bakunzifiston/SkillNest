...
<a href="{{ route('courses.lessons.show', [$course, $lesson]) }}"
   class="flex items-center gap-2 rounded-lg py-2 pl-2 pr-2 text-sm transition {{ $isCurrent ? 'bg-white/25 text-white ring-1 ring-white/40' : 'text-white/90 hover:bg-white/10' }}"
