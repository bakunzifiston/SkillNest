        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            @if($enrollments->isEmpty())
                <div class="text-center py-16 rounded-2xl bg-slate-50 border border-slate-100">
                    ...
                    <a href="{{ route('courses.index') }}" class="mt-4 inline-flex items-center px-5 py-2.5 rounded-xl bg-accent text-white font-semibold hover:bg-accent-dark transition">Browse courses</a>
                </div>
            @else
                    ...
                    @foreach($enrollments as $enrollment)
                        ...
                        <article class="group block bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-xl hover:border-accent-muted transition">
                            <a href="{{ route('courses.show', $course) }}" class="block">
                                ...
                                <div class="p-5">
                                    <h2 class="font-display font-semibold text-slate-900 group-hover:text-accent-dark line-clamp-2">{{ $course->title }}</h2>
                                    ...
                                    <span class="mt-4 inline-flex items-center text-primary font-semibold text-sm group-hover:underline">
