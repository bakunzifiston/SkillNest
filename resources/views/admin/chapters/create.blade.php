    ...
    <div class="max-w-xl">
        <form action="{{ route('admin.courses.chapters.store', $course) }}" method="post" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" required class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-accent focus:ring-accent" placeholder="e.g. Introduction">
