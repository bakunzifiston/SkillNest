                        ...
                        <li class="px-5 py-3 flex items-center justify-between hover:bg-gray-50/50">
                            <div class="flex items-center gap-3">
                                ...
                                @elseif($lesson->type === 'pdf')
                                    <span class="flex items-center justify-center w-8 h-8 rounded bg-accent-light text-accent" title="PDF"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clip-rule="evenodd"/></svg></span>
                                @else
