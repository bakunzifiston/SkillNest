    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.chapters.lessons.store', $chapter) }}" method="post" enctype="multipart/form-data" class="space-y-5" id="lesson-form">
            ...
            <div id="field-text" class="lesson-type-fields">
                ...
                <textarea name="content" id="content" rows="6" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring-amber-500">{{ old('content') }}</textarea>
            ...
            <div id="field-youtube" class="lesson-type-fields hidden">
                ...
                <input type="url" name="source_url" id="source_url" value="{{ old('source_url') }}" placeholder="https://www.youtube.com/watch?v=..." class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring-amber-500">
            ...
            <div class="flex gap-3">
                <button type="submit" class="px-4 py-2 bg-amber-500 text-white rounded-lg font-medium hover:bg-amber-600">Add lesson</button>
