    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.lessons.update', $lesson) }}" method="post" enctype="multipart/form-data" class="space-y-5" id="lesson-form">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title', $lesson->title) }}" required class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-accent focus:ring-accent">
            ...
            <div id="field-text" class="lesson-type-fields {{ $lesson->type === 'text' ? '' : 'hidden' }}">
                ...
                <textarea name="content" id="content" rows="6" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-accent focus:ring-accent">{{ old('content', $lesson->content) }}</textarea>
            ...
            <div id="field-youtube" class="lesson-type-fields {{ $lesson->type === 'youtube' ? '' : 'hidden' }}">
                ...
                <input type="url" name="source_url" id="source_url" value="{{ old('source_url', $lesson->source_url) }}" placeholder="https://www.youtube.com/watch?v=..." class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-accent focus:ring-accent">
