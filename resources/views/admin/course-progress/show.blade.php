        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($rows as $row)
                    <tr>
                        <td class="px-6 py-4 font-medium text-gray-900">{{ $row->user->displayFirstName() ?: '—' }}</td>
                        <td class="px-6 py-4 font-medium text-gray-900">{{ $row->user->displayLastName() ?: '—' }}</td>
                        <td class="px-6 py-4 text-sm text-gray-500">{{ $row->user->email }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="px-6 py-8 text-center text-gray-500">No students enrolled in this course yet.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
