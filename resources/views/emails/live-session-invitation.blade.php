...
<body style="font-family: sans-serif; line-height: 1.6; color: #334155; max-width: 560px; margin: 0 auto; padding: 20px;">
    ...
    <p style="margin-top: 24px;">
        <a href="{{ $liveSession->meeting_url }}" style="display: inline-block; padding: 12px 24px; background: #F16029; color: #fff; text-decoration: none; border-radius: 8px; font-weight: 600;">Join the session</a>
    </p>
