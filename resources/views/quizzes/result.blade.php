...
@section('content')
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        @endif
        <a href="{{ route('courses.show', $quizAttempt->quiz->course) }}" class="text-primary hover:underline text-sm font-medium">← Back to course</a>
        <div class="mt-6 bg-white rounded-2xl border border-slate-200 p-8">
            ...
            <div class="mt-6 flex items-center gap-4">
                ...
                @if($quizAttempt->passed)
                    <span class="px-4 py-2 rounded-xl bg-success-muted text-success-darker font-semibold">Passed</span>
                @else
        ...
        <div class="mt-6">
            <a href="{{ route('courses.show', $quizAttempt->quiz->course) }}" class="inline-flex items-center px-6 py-3 rounded-xl bg-accent text-white font-semibold hover:bg-accent-dark transition">Back to course</a>
        </div>
    </div>
@endsection
